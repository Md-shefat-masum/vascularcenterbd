...
@section('contents')
                                    ...
                                    @foreach ($infos as $key => $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Are you sure?')" href="{{ route('editor_contact_information_delete',['id'=>$item->id]) }}" class="btn btn-danger btn-sm m-1"><i class="fa fa-trash"></i> Delete</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
        ...
        <div class="modal-dialog modal-lg modal-center" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCreateLabel">Add Contact Information</h5>
                ...
                <div class="modal-body">
                    <!-- Modal body -->
                    <form id="contact_create_form" action="{{ route('editor_contact_information_store') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="modal-body">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select" aria-label="select example" name="title" id="title">
                                    ...
                                    @foreach ( $contact_title as $key => $val)
                            ...
                            <div class="form-group mb-3">
                                <label for="value">Contact Description</label>
                                <input type="text" value="" id="value" name="value" class="form-control input_val" placeholder="Contact description....." required/>
                            </div>
                            <div class="form-group d-none">
                                <input type="text" value="contact_information" id="type_name" name="type_name"/>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="exampleModalUpdate" tabindex="-1" aria-labelledby="exampleModalUpdateLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-center" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalUpdateLabel">Add Contact Information</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"></span>
                    </button>
                </div>
                <div class="modal-body">
                    <!-- Modal body -->
                    <form id="contact_update_form" action="{{ route('editor_contact_information_update') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="modal-body">
                            <div class="form-group mb-3">
                                <label for="title">Contact Title</label>
                            ...
                            <div class="form-group mb-3">
                                <label for="value">Contact Description</label>
                                <input type="text" value="" id="update_value" name="value" class="form-control input_val" placeholder="Contact description....." required/>
                            </div>
