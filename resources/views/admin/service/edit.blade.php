            ...
            <div class="row mb-4">
                <div class="col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" class="update_form" action="{{ route('service.update',$service->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" name="title" class="form-control" id="input-21">{!! str_replace("<br />", "", $service->title) !!}</textarea>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" name="details" class="form-control" id="input-21" >{!! str_replace("<br />", "", $service->details) !!}</textarea>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <img class="img-thumbnail my-3" style="width: 200px;" src="/{{ $service->image }}" alt="">
                                    </div>
                                </div>
