                                        ...
                                        <tr>
                                            ...
                                            <td scope="row" style="width: 300px;">
                                                <div class="text-right">
                                                    <a type="button" href="{{ route('service.edit',$item->id) }}" class="btn btn-warning waves-effect waves-light m-1">
                                                        <i class="fa fa-pencil"></i> <span>edit</span>
                                                    </a>
                                                    <a type="button" onclick="return confirm('sure want to delete')" href="{{ route('service.destroy',$item->id) }}"
