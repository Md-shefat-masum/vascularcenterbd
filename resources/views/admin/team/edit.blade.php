                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between flex-wrap">
                            ...
                            <a class="btn btn-primary" href="{{ route('video.index') }}"><i class="fa fa-arrow-left"></i> go back</a>
                        </div>
                        <div class="card-body">
                            <form method="POST" class="update_form" action="{{ route('video.update',$video->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" name="title" class="form-control" id="input-21">{!! str_replace("<br />", "", $video->title) !!}</textarea>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" name="details" class="form-control" id="input-21" >{!! str_replace("<br />", "", $video->details) !!}</textarea>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <img class="img-thumbnail my-3" style="width: 200px;" src="/{{ $video->image }}" alt="">
                                    </div>
                                </div>
