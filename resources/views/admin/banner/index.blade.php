                                ...
                                <tbody>
                                    @foreach ($collection as $key=>$item)
                                        <tr>
                                            ...
                                            <td scope="row">{!! $item->banner_title !!}</td>
                                            <td scope="row">{!!  $item->banner_sub_title !!}</td>
                                            <td scope="row">
                                            ...
                                            <td scope="row" style="width: 300px;">
                                                <div class="text-right">
                                                    ...
                                                    <a type="button" onclick="return confirm('sure want to delete')" href="{{ route('banner.destroy',$item->id) }}"
