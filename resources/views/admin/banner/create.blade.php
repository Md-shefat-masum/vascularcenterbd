                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" class="insert_form" action="{{ route('banner.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" name="banner_title" class="form-control" id="input-21" placeholder="banner title" ></textarea>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" name="banner_sub_title" class="form-control" id="input-21" placeholder="banner subtitle" ></textarea>
