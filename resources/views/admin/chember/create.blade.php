                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between flex-wrap">
                            <div class="card-title">Create Chember</div>
                            <a class="btn btn-primary" href="{{ route('chember.index') }}"><i class="fa fa-arrow-left"></i> go back</a>
                        </div>
                        <div class="card-body">
                            {{-- <hr /> --}}
                            <form method="POST" class="insert_form" action="{{ route('chember.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="preloader"></div>
                                <div class="form-group row mb-4">
                                    <label for="input-21" class="col-sm-2 col-form-label">Location</label>
                                    <div class="col-sm-10">
                                        <textarea type="text" name="location" class="form-control" id="input-21"></textarea>
