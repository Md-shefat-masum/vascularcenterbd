...
class CreateWebsiteBlogCategoryInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('website_blog_category_infos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('website_blog_category_infos');
    }
}
